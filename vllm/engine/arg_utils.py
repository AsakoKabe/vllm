...
class EngineArgs:
    ...
    spec_decode_timing: bool = ObservabilityConfig.spec_decode_timing
    spec_decode_trace_path: str | None = ObservabilityConfig.spec_decode_trace_path
    ...
    def add_cli_args(parser: FlexibleArgumentParser) -> FlexibleArgumentParser:
        ...
        observability_group.add_argument(
            "--spec-decode-timing",
            **observability_kwargs["spec_decode_timing"],
        )
        observability_group.add_argument(
            "--spec-decode-trace-path",
            **observability_kwargs["spec_decode_trace_path"],
        )
        observability_group.add_argument(
    ...
    def create_observability_config(self) -> ObservabilityConfig:
        return ObservabilityConfig(
            ...
            spec_decode_timing=self.spec_decode_timing,
            spec_decode_trace_path=self.spec_decode_trace_path,
